...
from modules.DASsearch import GetDatasetFromDAS
from modules.paths import IHEP_path
from modules.fileReader import GetFiles, GetAllInfoFromFile
basepath = IHEP_path("") # Just want path to topcoffea/topcoffea, not any particular file within it, so just pass "" to the function
